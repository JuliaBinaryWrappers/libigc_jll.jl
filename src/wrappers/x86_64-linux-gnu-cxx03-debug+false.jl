# Autogenerated wrapper script for libigc_jll for x86_64-linux-gnu-cxx03-debug+false
...
JLLWrappers.@declare_library_product(libopencl_clang, "libopencl-clang.so.14")
